...
return [
    ...
    'rich_editor' => [
        'image' => [
            'button' => 'Фото',
            'modal_heading' => 'Вставити фото',
            'file_new' => 'Файл фото',
            'file_existing' => 'Замінити фото',
            'title' => 'Title',
            'alt' => 'Alt текст',
            'width' => 'Ширина',
            'height' => 'Висота',
            'dimension_hint' => 'Необовʼязково. Можна вказати пікселі або CSS-одиниці, наприклад %.',
        ],
    ],
    'resources' => [
        'attribute_group' => [
    ...
    'site_setting' => [
        ...
        'mail_section' => 'Налаштування відправки пошти',
        'mail_from_email' => 'Адреса відправника',
        'mail_from_email_hint' => 'Якщо поле порожнє, використовується адреса з конфігурації пошти.',
        'mail_from_name' => 'Ім’я відправника',
        'mail_from_name_hint' => 'Якщо поле порожнє, використовується ім’я з конфігурації пошти.',
        ...
        'address_label_hint' => 'Цей підпис буде показано на сторінці контактів замість тексту адреси.',
        'address_locale' => 'Мова відображення адреси',
        ...
        'address_location_picker' => 'Локація магазину',
        'address_location_find_action' => 'Знайти на карті',
        'address_location_missing_key' => 'Вкажіть API ключ Google Maps, щоб увімкнути пошук адреси та карту.',
        'address_location_load_failed' => 'Не вдалося завантажити Google Maps. Перевірте API ключ і дозволи для Maps JavaScript API та Places API.',
        'address_location_not_found' => 'Не вдалося знайти адресу. Уточніть запит або перемістіть маркер вручну.',
