...
return [
    ...
    'site_setting' => [
        ...
        'address_location_picker' => 'Store location',
        'address_location_find_action' => 'Find on map',
        'address_location_missing_key' => 'Enter a Google Maps API key to enable address search and the map.',
        'address_location_load_failed' => 'Google Maps failed to load. Check the API key and access to Maps JavaScript API and Places API.',
        'address_location_not_found' => 'Address not found. Refine the query or move the marker manually.',
