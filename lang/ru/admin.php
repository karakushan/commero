...
return [
    ...
    'site_setting' => [
        ...
        'mail_section' => 'Настройки отправки почты',
        'mail_from_email' => 'Адрес отправителя',
        'mail_from_email_hint' => 'Если поле пустое, используется адрес из конфигурации почты.',
        'mail_from_name' => 'Имя отправителя',
        'mail_from_name_hint' => 'Если поле пустое, используется имя из конфигурации почты.',
        ...
        'contacts' => 'Контакты',
        'addresses' => 'Адреса магазина',
        'addresses_hint' => 'Общий блок для всех языков. Первый заполненный адрес можно использовать на странице контактов.',
        'address_label_hint' => 'Эта подпись будет показана на странице контактов вместо текста адреса.',
        'address_locale' => 'Язык отображения адреса',
        'address_location_search' => 'Поиск геолокации',
        'address_location_search_placeholder' => 'Начните вводить адрес...',
        'address_location_search_hint' => 'Выберите адрес из подсказки Google, чтобы автоматически заполнить адрес и координаты.',
        'address_location_picker' => 'Локация магазина',
        'address_location_find_action' => 'Найти на карте',
        'address_location_missing_key' => 'Укажите API ключ Google Maps, чтобы включить поиск адреса и карту.',
        'address_location_load_failed' => 'Не удалось загрузить Google Maps. Проверьте API ключ и доступы к Maps JavaScript API и Places API.',
        'address_location_not_found' => 'Не удалось найти адрес. Уточните запрос или переместите маркер вручную.',
        'address_value' => 'Адрес',
        'address_coordinates' => 'Координаты',
        'address_coordinates_hint' => 'Формат: latitude,longitude. Например: 50.450100,30.523400',
        ...
        'price_currency_section' => 'Настройки цен и валют',
        ...
        'show_price_decimals' => 'Показывать копейки в ценах',
    ],
    'category' => [
        'tabs' => [
            'main' => 'Основное',
