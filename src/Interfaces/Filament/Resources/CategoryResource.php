...
class CategoryResource extends AdminResource
{
    ...
    {
        return __('commero::admin.resources.category.navigation');
    }
    ...
    {
        return __('commero::admin.resources.category.singular');
    }

    public static function getPluralModelLabel(): string
    {
        return __('commero::admin.resources.category.plural');
    }
                ...
                ->tabs([
                    Tabs\Tab::make(__('commero::admin.category.tabs.main'))
                        ...
                        ->schema([
                            ...
                            Select::make('parent_id')->label(__('commero::admin.common.parent_category'))->options(fn (): array => static::getLocalizedHierarchySelectOptions(Category::class))->searchable()->preload(),
        ...
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('products_count')
                    ->label(__('commero::admin.resources.product.plural'))
                    ->counts('products'),
            ])
            ->recordActions([
