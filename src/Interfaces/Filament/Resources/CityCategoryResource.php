...
class CityCategoryResource extends Resource
{
    ...
    {
        return __('admin.resources.city_category.navigation');
    }
    ...
    {
        return __('admin.resources.city_category.singular');
    }

    public static function getPluralModelLabel(): string
    {
        return __('admin.resources.city_category.plural');
    }
                    ...
                    Tabs\Tab::make(__('admin.category.tabs.main'))
                        ...
                        ->schema([
                            ...
                            Select::make('display_category_ids')
                                ->label(__('admin.city_category.display_category_ids'))
