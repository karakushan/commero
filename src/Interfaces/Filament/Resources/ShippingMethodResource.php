...
class ShippingMethodResource extends AdminResource
{
    ...
    {
        return __('commero::admin.resources.shipping_method.navigation');
    }
    ...
    {
        return __('commero::admin.resources.shipping_method.singular');
    }

    public static function getPluralModelLabel(): string
    {
        return __('commero::admin.resources.shipping_method.plural');
    }
